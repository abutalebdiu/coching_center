                            ...
                            <div class="form-group">
                                <label for="">Activate Status</label>
                                 <select name="activate_status" id="activate_status" class="form-control" required>
                                     ...
                                     <option {{$student->activate_status == 2 ?'selected' : ''}} value="2">In-active</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="father" id="father" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->father:'':'' }}" class="form-control" placeholder="Enter Father Name">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="mother" id="mother" value="{{  $student->user?$student->user->studentinfo?$student->user->studentinfo->mother:'':'' }}" class="form-control" placeholder="Enter Mother Name">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="guardianmobile" id="guardianmobile" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->guardian_mobile:'':'' }}" class="form-control" placeholder="Enter guardian mobile number" required>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="ownmobile" id="ownmobile" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->own_mobile:'':'' }}" class="form-control" placeholder="Enter own mobile number" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="whatsapp_number" id="whatsapp_number" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->whatsapp_number:'':'' }}" class="form-control" placeholder="Enter Whats app number">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook_id" id="facebook_id" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->facebook_id:'':'' }}" class="form-control" placeholder="Enter Facebook ID Link">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="bkash_number" id="bkash_number" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->bkash_number:'':'' }}" class="form-control" placeholder="Enter Bkash Number">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->email:'':'' }}" class="form-control" placeholder="Enter Email Address">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->address:'':'' }}" class="form-control" placeholder="Enter address">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="note" id="note" value="{{ $student->user?$student->user->studentinfo?$student->user->studentinfo->notes:'':'' }}" class="form-control" placeholder="Enter Note">
