...
@section('title','Edit Student Absent')
                ...
                <div class="col-xl-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-10">
                        <div class="panel-heading">
                            <h4 class="panel-title">Edit Student Absent</h4>
                        ...
                        <div class="panel-body">
                            <form action="{{ route('admin.absent.update',$absentStudent->id) }}" method="POST" >
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="student_id" id="" class=" student_id form-control" required >
                                                    ...
                                                    <option {{ $get_student_id ==  $student->id ? 'selected' : ''  }} {{ $absentStudent->student_id == $student->id ? 'selected' : '' }} value="{{ $student->id }}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="month_id[]" id="" class="test start_month_id form-control" multiple="multiple" required>
                                                    ...
                                                    @foreach($months as $month)
                                                        @php $c = 0; @endphp
                                                        @foreach($absentStudent->absentMonths  as $abcnMnt)
                                                            @if($abcnMnt->month_id == $month->id) 
                                                                @php $c = 1; @endphp
                                                                @break 
                                                            @endif
                                                        @endforeach
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label >Reason </label>
                                                <input type="text"  name="reason" value="{{$absentStudent->reason}}"  class="form-control "/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label >Note </label>
                                                <input type="text"  name="note" value="{{$absentStudent->notes}}"  class="form-control "/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="" class="form-control" required>
                                                    ...
                                                    <option {{ $absentStudent->status == 1 ? 'selected' : '' }} value="1">Active</option>
                                                    <option {{ $absentStudent->status == 2 ? 'selected' : '' }} value="2">Deactive</option>
                                                </select>
                                            </div>
                                        </div>
