                                     ...
                                     <div class="col-md-12">
                                         <div class="form-group">
                                             ...
                                             <select name="batch_id" id="" class="form-control" >
                                                 ...
                                                 <option {{ $batchsetting->batch->id == $batch->id ? 'selected' : '' }} value="{{ $batch->id }}">{{ $batch->name }}</option>
                                                 @endforeach
                                         </select>
                                         </div>
                                     </div>
                                       ...
                                       <div class="col-md-12">
                                          <table class="table table-bordered table-hovered">
                                             ...
                                             <tr>
                                                ...
                                                <td style="width:30%;">
                                                   <input type="number" name="amount[]" value="{{ $batchsetting->feeSettingAmount($feeCat->id)}}" 
                                                       data-id="{{$feeCat->id}}" id="checked_amount_id_{{$feeCat->id}}" class="type form-control" />
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                       <div class="col-md-6">
                                          ...
                                          <div class="col-md-12">
                                                <input type="text" name="amount" value="{{ $batchsetting->amount }}" placeholder="Enter Batch Amount" class="form-control">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
