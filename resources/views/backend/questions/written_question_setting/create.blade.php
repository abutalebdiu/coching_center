...
@section('title','Written Exam Setting ')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.written-setting.store') }}" method="post">
                    @CSRF
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$subjectQuestionName}}" disabled class=" form-control"/>
                                <input type="hidden" value="{{$question_subject_id}}" name="question_subject_id" />
                            </div>
                        </div>
