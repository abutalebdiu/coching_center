                ...
                <div class="panel-body">
                    <form action="{{ route('sheet.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter Sheet Name" />
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <select name="free_for" id="free_for" class="form-control">
                                ...
                                <option {{ old('free_for') == 1 ? 'selected' : '' }} value="1">Free for Online Student</option>
                                <option {{ old('free_for') == 2 ? 'selected' : '' }} value="2">Free for Offine Student</option>
                                <option {{ old('free_for') == 3 ? 'selected' : '' }} value="3">Full Free</option>
                                <option {{ old('free_for') == 4 ? 'selected' : '' }} value="4">Paid</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="publish_date" value="{{ old('publish_date') }}" class="form-control" placeholder="Enter publish date" />
