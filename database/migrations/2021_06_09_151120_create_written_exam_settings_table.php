...
class CreateWrittenExamSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('written_exam_settings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('written_exam_settings');
    }
}
